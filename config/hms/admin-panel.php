...
function display_patient_details() {
  ...
  while($row = mysqli_fetch_assoc($result)) {
      ...
      echo "<td><a href='admin-panel.php?edit=" . $row['pid'] . "' class='btn btn-warning'>Edit</a></td>";
      echo "</tr>";
  }
}
...
.btn-primary{
  ...
  <a href="view-update-details.php" class="btn btn-primary">Update My Details</a>
  <a href="view_user.php" class="btn btn-primary">View My Details</a>
            </div>
          </div>
